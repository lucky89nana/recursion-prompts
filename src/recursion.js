...
var sumBelow = function(n) {
  ...
  if (n < - 1) {
    var nAbs = Math.abs(n);
    var result = (nAbs - 1) + sumBelow(nAbs - 1);
    return -result;
  }
};
...
var exponent = function(base, exp) {
  ...
  if (exp < 0) {
    var expAbs = -exp;
    var result = base * exponent(base, expAbs - 1);
    return 1 / result;
  }
};
...
var fibonacci = function(n) {
  ...
  result.push(fibonacci(n -1)[n -1] + fibonacci(n -2)[n -2]);
  return result;
};
...
var compress = function(list) {
  ...
  var result = compress(list.slice(0, list.length - 1));
...
var minimizeZeroes = function(array) {
  ...
  var result = minimizeZeroes(array.slice(0, array.length - 1));
...
var alternateSign = function(array) {
  ...
  var result1 = alternateSign(array.slice(0, array.length -1));
  if ((array.length - 1) % 2 === 1) {
    result1.push(-Math.abs(array[array.length - 1]));
  } else {
    result1.push(Math.abs(array[array.length - 1]));
  }
  return result1;
...
var numToText = function(str) {
  ...
  var result = numToText(str.slice(0, str.length - 1));
  var text = str[str.length - 1];
  switch (text) {
    case '1':
      text = 'one';
      break;
